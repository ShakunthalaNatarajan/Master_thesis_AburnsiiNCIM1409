...
#PART 4
"""
 alternaria_nimmoniana_lrs_blast is the result file of blasting alternaria burnsii against Nothapodytes nimmoniana
 combined leaf, root, stem sequences. alternaria_nimmoniana_stem_blast was input into blast2best.py script to 
 obtain best hits per query sequence and the result file is stored as alter_nimmoLRS_best.
 ...
 called alter_nimmoLRS_with_filters
"""
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/alter_nimmoLRS_best",'r')as f:
    with open("/home/shlaakuntha/Downloads/project/max_bit_score_sorted",'r')as f1:
        with open("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/alter_nimmoLRS_with_filters",'w')as out:
            line=f.readline()
            ln=f1.readlines()
            parts2=[]
            for each in ln:
...
"""
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/alter_nimmoLRS_with_filters","r") as f:
    with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/alter_nimmoLRS_top_hits","w")as out:
        line=f.readline()
        while line:
            parts=line.strip().split()
            #threshold for pident=60; threshold for length=50. 
            #So all sequences having pident<60 and length<50 will be filtered out.
            if (float(parts[2])>55 and float(parts[3])>50 and (float(parts[11])/float(parts[12]))>0.1):
                out.write(line)
            line=f.readline()
#PART 6
"""
...
cpt_nimmoS_top_hits
"""
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/cpt_probables_nimmoniana_lrs_blast","r") as f:
    with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/cpt_nimmoLRS_top_hits","w")as out:
        line=f.readline()
        while line:
            parts=line.strip().split()
            #threshold for pident=60; threshold for length=50. 
            ...
            if (float(parts[2])>60 and float(parts[3])>50):
                out.write(line)
            line=f.readline()
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/cpt_nimmoLRS_top_hits","r") as f:
    with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/nimmonianaLRS_cpt_candidate_genes","w")as out:
        line=f.readline()
        while line:
            parts=line.strip().split()
            out.write(parts[1]+"\n")
...
"""
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/alter_nimmoLRS_with_filters","r") as f:
    with open("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/nimmonianaLRS_cpt_candidate_genes",'r')as f1:
        with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/alter_nimmoLRS_match","w")as out:
            line=f.readline()
            ln=f1.readlines()
            parts2=[]
            for each in ln:
...
"""
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/alternaria_nimmoniana_lrs_blast","r") as f:
    with open("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/nimmonianaLRS_cpt_candidate_genes",'r')as f1:
        with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/alter_nimmoLRS_match_unfiltered","w")as out:
            line=f.readline()
            ln=f1.readlines()
            parts2=[]
            for each in ln:
...
"""
with open("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/alter_nimmoLRS_top_hits","r") as f:
    with open("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/nimmonianaLRS_cpt_candidate_genes",'r')as f1:
        with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/cpt_candidates_alternaria_nimmoLRS","w")as out:
            line=f.readline()
            ln=f1.readlines()
            parts2=[]
            for each in ln:
            ...
            while line:
                ...
                for i in parts2:
                    if parts1[1]==i[0]:
                        ...
                        out.write(str(linenew)+"\n")
                line=f.readline()
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_LRS_BLASTp/cpt_candidates_alternaria_nimmoLRS","r")as f2:
    lns=f2.readlines()
    parts3=[]
    for eachone in lns:
