...
#PART 4
"""
 alternaria_nimmoniana_root_blast is the result file of blasting alternaria burnsii against Nothapodytes nimmoniana
...
"""
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/alter_nimmoR_best",'r')as f:
    with open("/home/shlaakuntha/Downloads/project/max_bit_score_sorted",'r')as f1:
        with open("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/alter_nimmoR_with_filters",'w')as out:
            line=f.readline()
            ln=f1.readlines()
            parts2=[]
            for each in ln:
...
the contents to a new file called alter_nimmoR_top_hits
"""
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/alter_nimmoR_with_filters","r") as f:
    with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/alter_nimmoR_top_hits","w")as out:
        line=f.readline()
        while line:
...
cpt_nimmoR_top_hits
"""
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/cpt_probables_nimmoniana_root_blast","r") as f:
    with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/cpt_nimmoR_top_hits","w")as out:
        line=f.readline()
        while line:
            parts=line.strip().split()
            #threshold for pident=60; threshold for length=50. 
            ...
            if (float(parts[2])>60 and float(parts[3])>50):
                out.write(line)
            line=f.readline()
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/cpt_nimmoR_top_hits","r") as f:
    with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/nimmonianaR_cpt_candidate_genes","w")as out:
        line=f.readline()
        while line:
            parts=line.strip().split()
            out.write(parts[1]+"\n")
...
file alter_nimmoR_with_filters which basically has all the columns of alter_nimmoR_best and an
additional column containing the maximum bit score for each query sequence. The results are in a file
called alter_nimmoR_match
"""
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/alter_nimmoR_with_filters","r") as f:
    with open("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/nimmonianaR_cpt_candidate_genes",'r')as f1:
        with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/alter_nimmoR_match","w")as out:
            line=f.readline()
            ln=f1.readlines()
            parts2=[]
            for each in ln:
...
from original alternaria_nimmoniana_root_blast file. Results are in alter_nimmoR_match_unfiltered
"""
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/alternaria_nimmoniana_root_blast","r") as f:
    with open("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/nimmonianaR_cpt_candidate_genes",'r')as f1:
        with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/alter_nimmoR_match_unfiltered","w")as out:
            line=f.readline()
            ln=f1.readlines()
            parts2=[]
            for each in ln:
...
#PART 9
"""
script to find cpt candidate genes of Nothapodytes nimmoniana in the alter_nimmoR_top_hits file. 
This is to see if there are any top hits resembling the CPT candidate genes in Nothapodytes nimmoniana
"""
with open("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/alter_nimmoR_top_hits","r") as f:
    with open("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/nimmonianaR_cpt_candidate_genes",'r')as f1:
        with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/cpt_candidates_alternaria_nimmoR","w")as out:
            line=f.readline()
            ln=f1.readlines()
            parts2=[]
            for each in ln:
            ...
            while line:
                ...
                for i in parts2:
                    if parts1[1]==i[0]:
                        ...
                        out.write(str(linenew)+"\n")
                line=f.readline()
with open ("/home/shlaakuntha/Downloads/project/Alternaria_Nimmoniana_Root_BLASTp/cpt_candidates_alternaria_nimmoR","r")as f2:
    lns=f2.readlines()
    parts3=[]
    for eachone in lns:
